...
typedef struct {
    ...
    volatile  uint32_t SEQ_GDAT[2];                       /**< ADC Sequence-n Global Data register. This register contains the result of the most recent ADC conversion performed under sequence-n., array offset: 0x10, array step: 0x4 */
       	   	  uint8_t RESERVED_1[8];
    volatile  uint32_t DAT[12];                           /**< ADC Channel N Data register. This register contains the result of the most recent conversion completed on channel N., array offset: 0x20, array step: 0x4 */
...
#define DAC0	((DAC_Type *) 0x40014000u)
#define DAC1	((DAC_Type *) 0x40018000u)
...
#define ACMP	((ACMP_Type *) 0x40024000u)
